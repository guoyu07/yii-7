...
class ModelCode extends CCodeModel
{
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			array('shardingKey,idTableName,tablePrefix, baseClass, tableName, modelClass, modelPath, connectionId', 'filter', 'filter'=>'trim'),
			...
			array('modNum,shardingType,idTableName,connectionId,shardingKey,tablePrefix, modelPath, baseClass, buildRelations, commentsAsLabels', 'sticky'),
		));
	}
